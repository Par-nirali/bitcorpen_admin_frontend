...
const Slidebar = ({
  ...
  // console.log(selectedemp, "hiihiihiihiih");
  ...
  // }, []);
  // useEffect(() => {
  //   const submanlocal = localStorage.getItem("submanager");

  //   if (submanlocal) {
  //     console.log(submanlocal, "submanlocal");
  //     dispatch(selectedProjects(submanlocal));
  //     setSelectedProject(submanlocal);
  //   }
  // }, []);
    ...
    const submanager = async () => {
      if (userDetail && userDetail._id) {
        try {
          ...
          // console.log(res.data, "submanagerrrr Data");
  ...
  // console.log("ceo dept id", ceodepartmentid);
  // console.log("subman name is", submanagername);
  // console.log("length is", selectedemp.length);
      ...
      <div className={styles.wSpaceLeftMain}>
        <div className={styles.wSpaceLeftSub}>
          <div className={styles.wSpaceLeftUp}>
            ...
            {/* imp dont removie comments */}
            {/* <div className={styles.wSpaceLeftHead}> */}
            ...
            <div className={styles.slidebarRoutes}>
                ...
                <>
                  <div
                    className={`${styles.wSpaceLeftHead} ${
                      // selectedProject === "all projects" ? styles.selected : ""
              ...
              {(userDetail?.designation?.name === "EMPLOYEE" ||
                ...
                <>
                  ...
                  {/* <div
                    className={`${styles.wSpaceLeftHead} ${
                      selectedproject === "my projects" ? styles.selected : ""
                    }`}
                  ...
                  {submanager.map((subman: any) => (
                    <div
                      ...
                      onClick={() => {
                        ...
                        // localStorage.setItem("submanager", subman._id);
              ...
              {userDetail?.designation?.name === "CEO" && (
                <>
                  {/* <div
                    ...
                    onClick={() => dispatch(selectedProjects("ceo dashboard"))}
                    data-button-type="home"
                  >
                    <img src="/homeb.svg" />
                    <p>Dashboard</p>
                  ...
                  {/* <div
                    ...
                    onClick={() => dispatch(selectedProjects("ceoempreview"))}
                    data-button-type="home"
                  >
                    <img src="/homeb.svg" />
                    <p>Review</p>
                  ...
                  {/* <div
                    ...
                    onClick={() => dispatch(selectedProjects("ceoempprojects"))}
                    data-button-type="myprojects"
                  >
                    <img src="/myprojectsb.svg" />
                    <p>Projects Done</p>
                  ...
                  {!showemp ? (
                    ...
                    <>
                      {/* Employee Review and Projects Done */}
                      <div
                        className={`${styles.wSpaceLeftHead} ${
                          selectedproject === "ceo dashboard"
